module iiitb_icg (VGND,
 ...
 sky130_vsdinv _4_ (.A(\dff1.q ),
    ...
    .VPWR(VPWR),
    .VGND(VGND));
 sky130_vsdinv _5_ (.A(clk),
    .Y(_0_),
    .VPWR(VPWR),
    .VGND(VGND));
 sky130_fd_sc_hd__dfxtp_1 _6_ (.CLK(cgclk),
    .D(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(net5));
 sky130_fd_sc_hd__dfxtp_1 _7_ (.CLK(cgclk),
    .D(net1),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(net4));
 sky130_fd_sc_hd__dfxtp_1 _8_ (.CLK(clk),
    .D(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\dff1.q ));
 sky130_fd_sc_hd__dfxtp_1 _9_ (.CLK(_0_),
    .D(\dff2.d ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
