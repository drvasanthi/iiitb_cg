module iiitb_icg (VGND,
 ...
 wire clknet_0_cgclk;
 wire clknet_0_clk;
 wire clknet_1_0__leaf_cgclk;
 wire clknet_1_0__leaf_clk;
 wire clknet_1_1__leaf_cgclk;
 ...
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_34 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__and2_2 _2_ (.A(\dff2.q ),
 ...
 sky130_fd_sc_hd__buf_1 _3_ (.A(_1_),
    ...
    .VPWR(VPWR),
    .X(cgclk));
 sky130_vsdinv _4_ (.A(\dff1.q ),
    .Y(\dff2.d ),
    .VPWR(VPWR),
    .VGND(VGND));
 sky130_vsdinv _5__1 (.A(clknet_1_0__leaf_clk),
    .Y(net6),
    .VPWR(VPWR),
    .VGND(VGND));
 sky130_fd_sc_hd__dfxtp_1 _6_ (.CLK(clknet_1_0__leaf_cgclk),
    .D(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(net5));
 sky130_fd_sc_hd__dfxtp_1 _7_ (.CLK(clknet_1_1__leaf_cgclk),
    .D(net1),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_1 _8_ (.CLK(clknet_1_0__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\dff1.q ));
 sky130_fd_sc_hd__dfxtp_1 _9_ (.CLK(net6),
    .D(\dff2.d ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\dff2.q ));
 sky130_fd_sc_hd__clkbuf_16 clkbuf_0_cgclk (.A(cgclk),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_16 clkbuf_0_clk (.A(clk),
    ...
    .VPWR(VPWR),
    .X(clknet_0_clk));
 sky130_fd_sc_hd__clkbuf_16 clkbuf_1_0__f_cgclk (.A(clknet_0_cgclk),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(clknet_1_0__leaf_cgclk));
 ...
 sky130_fd_sc_hd__clkbuf_16 clkbuf_1_1__f_cgclk (.A(clknet_0_cgclk),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(clknet_1_1__leaf_cgclk));
 ...
 sky130_fd_sc_hd__clkbuf_1 input1 (.A(d0),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net1));
 sky130_fd_sc_hd__clkbuf_1 input2 (.A(d1),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net2));
 sky130_fd_sc_hd__clkbuf_1 input3 (.A(in),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
